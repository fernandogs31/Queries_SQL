SELECT distinct HOU.ORGANIZATION_CODE EMPRESA,
                ...
                dbms_lob.substr(RI.COMMENTS, 5000, 1) INFORMAÇOES_ADICIONAIS,
...
WHERE 1 = 1
   ...
   AND trunc(REO.RECEIVE_DATE) between  TO_date('01/10/2024', 'dd/mm/yyyy') and  TO_date('01/11/2024', 'dd/mm/yyyy')
