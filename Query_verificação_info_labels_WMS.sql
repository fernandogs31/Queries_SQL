select wlrh.*       
from apps.WMS_LABEL_REQUESTS_HIST_V wlrh,
     apps.org_organization_definitions ood
where wlrh.request_date >= '01-APR-2024'
and ood.organization_id in(10345,10346)
and ood.organization_id = wlrh.organization_id;

//
select *
from apps.WMS_LABEL_REQUESTS_HIST_V 


<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE labels SYSTEM "label.dtd">
<labels _FORMAT="GPORCPT" _QUANTITY="1" _PRINTERNAME="brextzebratest211" _JOBNAME="U52L150871132">
<label _FORMAT="GPORCPT">
<variable name= "Quantity"></variable>
<variable name= "Dolly_LPN"></variable>
<variable name= "Destination"></variable>
<variable name= "Document Type"></variable>
<variable name= "Document ID"></variable>
<variable name= "Hazard_Class"></variable>
<variable name= "Serial_Number"></variable>
<variable name= "Lot_Number"></variable>
<variable name= "Expiration_Date"></variable>
<variable name= "ReceiptNumber"></variable>
<variable name= "ReceiptDate"></variable>
<variable name= "LPN">CS47800019876</variable>
<variable name= "Receiver_SSO">550002090</variable>
<variable name= "Document Number"> - </variable>
<variable name= "Consumption_Rate"> </variable>
<variable name= "UN_Number"> </variable>
<variable name= "Item_Number"></variable>
<variable name= "GDR_Item_Number"></variable>
<variable name= "GDR_Field_Label"></variable>
<variable name= "Swap"></variable>
<variable name= "Additional_Info">Spare Part Only</variable>
<variable name= "Bin_Bulk"> </variable>
</label>
</labels>
